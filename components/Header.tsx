    ...
    const Header = () => {
        return (
            <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/95 backdrop-blur">
                <div className="container flex h-16 max-w-screen-2xl items-center justify-between px-4 md:px-6 mx-auto"> {/* Added mx-auto */}
                    {/* Logo */}
                    <Link href="/" legacyBehavior>
                        <a className="mr-6 flex items-center space-x-2" aria-label="RB Automotive Homepage">
                            ...
                            <Image
                             ...
                             />
                            <span className="hidden font-bold sm:inline-block text-lg font-roboto-slab text-red-700"> {/* Use font-roboto-slab */}
                                RB Automotive
                            </span>
                        </a>
                    </Link>
                    ...
                    <nav className="hidden md:flex gap-6 text-sm font-medium">
                        ...
                        {/* <Link href="/why-us" legacyBehavior><a className="text-gray-600 transition-colors hover:text-gray-900">Why Us</a></Link> */}
                        <Link href="/contact" legacyBehavior><a className="text-gray-600 transition-colors hover:text-gray-900">Contact</a></Link>
                        {/* <Link href="/reviews" legacyBehavior><a className="text-gray-600 transition-colors hover:text-gray-900">Reviews</a></Link> */}
                        {/* <Link href="/faq" legacyBehavior><a className="text-gray-600 transition-colors hover:text-gray-900">FAQ</a></Link> */}
                    </nav>
