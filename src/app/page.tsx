    ...
    import ImageWithFallback from '../components/ImageWithFallback'; // Relative path
    import { IconCalendarPlus, IconPhoneCall, IconWrench, IconDiagnostics, IconOil, IconEmergency } from '../components/Icons'; // Relative path
        ...
        <>
                ...
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                    <div className="flex flex-col justify-center space-y-6 text-center lg:text-left">
                        <div className="space-y-4">
                            ...
                            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl text-white font-slab">
          ...
          <section className="py-16 lg:py-24 bg-white">
              <div className="container mx-auto px-4 text-center">
                  <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-900 font-slab">Our Core Services</h2>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                      <div className="text-center p-4 transition-transform hover:scale-105">
                          ...
                          <h3 className="font-semibold mb-1 font-slab">General Repairs</h3>
                       ...
                       <div className="text-center p-4 transition-transform hover:scale-105">
                          ...
                          <h3 className="font-semibold mb-1 font-slab">Diagnostics</h3>
                       ...
                       <div className="text-center p-4 transition-transform hover:scale-105">
                          ...
                          <h3 className="font-semibold mb-1 font-slab">Servicing</h3>
                       ...
                       <div className="text-center p-4 transition-transform hover:scale-105">
                          ...
                          <h3 className="font-semibold mb-1 font-slab">24/7 Emergency</h3>
