...
// Using SVG paths similar to Lucide icons (https://lucide.dev/)
...
export const IconCheck = (props: IconProps) => (
    <svg
        ...
        {...props} // Spread props to allow className, size overrides etc.
    >
...
// Add other icons used (Wrench, Receipt, Settings, ThumbsUp, etc.) here in the same format...
